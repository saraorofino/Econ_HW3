...
**Data**: A contingent valuation survey to 500 Santa Barbara County residents was given to determine the local demand for a VSR program. Variables measured are: (1) _risk_: level of risk reduction, (2) _bid_: annual payment for the household, (3) _vote_: 1 is yes, 0 is no, (4) _NEP_ : measure of environmental concern, (5) _age_: categorical, (6) _income_: categorical.[^3]   
...
[^4]: See Technical Appendix 1; Linear model is used, instead of logistic, because the ease of interpretation.
